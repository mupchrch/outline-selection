...
export default class OutlineSelectionView {
  ...
  constructor(borderStyle) {
    ...
    outlineTopElem.style.borderTop = borderStyle;
    outlineTopElem.style.borderLeft = borderStyle;
    ...
    outlineBottomElem.style.borderBottom = borderStyle;
    outlineBottomElem.style.borderRight = borderStyle;
    ...
    outlineLeftElem.style.borderTop = borderStyle;
    outlineLeftElem.style.borderLeft = borderStyle;
    ...
    outlineRightElem.style.borderBottom = borderStyle;
    outlineRightElem.style.borderRight = borderStyle;
